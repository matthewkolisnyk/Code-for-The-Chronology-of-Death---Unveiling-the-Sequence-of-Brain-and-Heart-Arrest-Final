%% get key information from TCD and ABP signals at the time of loss of brain blood flow
...
% extract 60 seconds pre and post loss of systemic circulation
...
% do the same for ECG
WR  = fs/1.1;
[peakValuesECG, peakIndicesECG] = findpeaks(ECGCCA,'MinPeakDistance',WR);
...
%% now plot for loss of systemic circulation
clear; close all;
