%% find loss of brain electrical activity 
...
% find the scale...
figure
plot(EEGmean(1:end) * 10e1)

figure
plot(EEGmean(1:end) * 10e2)

figure
plot(EEGmean(1:end) * 10e3)

figure
plot(EEGmean(1:end) * 10e4)

figure
plot(EEGmean(1:end) * 10e5)
...
hold on
plot(EEGmean(TCDClean.PP:TCDClean.PP+windowLengthSamples))
hold off
