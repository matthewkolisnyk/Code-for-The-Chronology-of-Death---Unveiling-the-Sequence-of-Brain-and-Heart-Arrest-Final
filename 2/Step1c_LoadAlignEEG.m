...
Last_QRS_EEG = 2637940;
Last_QRS_ECG = 2639010;

% shift the EEG to make the phys data
...
plot(EEGt(Last_QRS_sample - buffer:Last_QRS_sample + buffer,13)*10e5)
hold off

figure
hold on
plot(ECGt(Last_QRS_sample - buffer:Last_QRS_sample + buffer))
plot(EEGt(Last_QRS_sample - buffer:Last_QRS_sample + buffer,11)*10e4)
hold off

buffer = 1000;
figure
hold on
plot(EEGt(Last_QRS_sample - buffer:Last_QRS_sample + buffer,13:end)*10e4)
hold off
...
plot(EEGt(Last_PP_sample - buffer:Last_PP_sample + buffer,11)*10e4)
hold off
...
hold on
plot(ECGt(Last_PP_sample - buffer:Last_PP_sample + buffer))
plot(EEGt(Last_PP_sample - buffer:Last_PP_sample + buffer,13:end)*10e4)
hold off
...
Last_EEG_sec = Last_EEG - EEG_start;
...
plot(EEGt(Last_EEG_sample - buffer:Last_EEG_sample + buffer,11)*10e5)
hold off
...
hold on
plot(ECGt(Last_EEG_sample - buffer:Last_EEG_sample + buffer))
plot(EEGt(Last_EEG_sample - buffer:Last_EEG_sample + buffer,13:end)*10e5)
hold off

%% proposed time for cessation of cerebral circulatory arrest 
Last_CCA =  "";

Last_CCA_sec = Last_CCA - EEG_start;
Last_CCA_sample = Last_CCA_sec * (fs);

figure
plot(ECGt)
hold on
plot(EEGt(:,14))
xline(Last_CCA_sample)
hold off

buffer = 10000;
figure
hold on
plot(ECGt(Last_CCA_sample - buffer:Last_CCA_sample + buffer))
plot(EEGt(Last_CCA_sample - buffer:Last_CCA_sample + buffer,11)*10e4)
hold off
...
hold on
plot(ECGt(Last_CCA_sample - buffer:Last_CCA_sample + buffer))
plot(EEGt(Last_CCA_sample - buffer:Last_CCA_sample + buffer,13:end)*10e4)
hold off
